# Quick build yourself CKEditor

1. CKEditor 5 editor generated with the [Online builder tool](https://ckeditor.com/ckeditor-5/online-builder)

1. Download the file and open it

1. Update `src/ckeditor.js` file
...
You can create an issue on https://github.com/ckeditor/ckeditor5/issues including the build id - `9l0lcffe5bsq-uxqijbsa3zrv`. Make sure that the question / problem is unique, please look for a possibly asked questions in the search box. Duplicates will be closed.
